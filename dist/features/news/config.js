...
import { buildWeekdayLabels, deriveWeekFirstDay, normalizeSiteLocale } from '../../shared/i18n';
const defaultNewsLabels = {
...
function normalizeWeekFirstDay(value) {
    return typeof value === 'number' && Number.isInteger(value) && value >= 0 && value <= 6
        ? value
        : null;
}
export function formatNewsLabel(template, label) {
